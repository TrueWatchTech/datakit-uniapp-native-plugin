#
# Be sure to run `pod lib lint TrueWatchPlugin.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.2.3'
  s.summary          = 'A short description of TrueWatchPlugin.'
  ...
  s.homepage         = 'https://github.com/TrueWatch-UniPlugin-App'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  # s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'hulilei' => 'huuuu1016@gmail.com' }

    #For local packaging only; remote repository not required.
  s.source           = { :git => 'https://github.com/TrueWatch-UniPlugin-App.git', :tag => s.version.to_s }
...
#  }
  # s.resource_bundles = {
  #   'TrueWatchPlugin' => ['TrueWatchPlugin/Assets/*.png']
  # }
